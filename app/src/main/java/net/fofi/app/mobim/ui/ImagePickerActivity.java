...
import net.fofi.app.mobim.BaseActivity;
import net.fofi.app.mobim.model.RecyclingImageView;
import net.fofi.app.mobim.model.VideoEntity;
import net.fofi.app.mobim.utils.ImageCache;
import net.fofi.app.mobim.utils.ImageResizer;
